...
export declare class EmployeePayrollService {
    ...
    get_all_employees_by_user_id_service(userId: string): Promise<EmployeePayroll[]>;
    get_single_employee_by_uuid_service(uuid: string): Promise<EmployeePayroll>;
    create_employee_service(dto: any): Promise<EmployeePayroll[]>;
    update_employee_details_service(uuid: string, dto: any): Promise<EmployeePayroll>;
    toggle_employee_status_service(uuid: string): Promise<EmployeePayroll>;
    delete_employee_keep_history_service(uuid: string): Promise<import("typeorm").UpdateResult>;
    ...
    bulk_update_employee_salaries_service(updates: any[]): Promise<void>;

...
const TIER_COLORS: Record<PlanTier, { bg: string; color: string }> = {
  starter:    { bg: "rgba(100,116,139,0.10)", color: "#64748B" },
  pro:        { bg: "rgba(59,130,246,0.10)",  color: "#3B82F6" },
  enterprise: { bg: "rgba(232,105,10,0.10)",  color: "var(--accent)" },
  custom:     { bg: "rgba(139,92,246,0.10)",  color: "#8B5CF6" },
};
                    ...
                    <td className="px-4 py-3.5">
                      <div className="flex flex-col gap-1">
                        ...
                        {sub.cancelAtPeriodEnd && (
                          <span className="text-[9.5px]" style={{ color: "var(--accent)" }}>

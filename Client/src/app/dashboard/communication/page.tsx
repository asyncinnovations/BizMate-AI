                  ...
                  {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"].map(
                    (day, idx) => (
                      <div key={day} className="flex items-center gap-3">
                        <span className="text-sm text-[#344767] w-24">
                          {day}
                        </span>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-2 border-dashed border-[#2E69A4] rounded-xl p-8 text-center hover:bg-blue-50 transition-colors cursor-pointer">
                    ...
                    <label htmlFor="file-upload" className="cursor-pointer">
                      <Upload
                        size={48}
                        className="text-[#2E69A4] mx-auto mb-4"
                      />
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[#344767]">
                          Based on your recent conversations, we recommend
                          adding FAQs about &qout;delivery timeframes&qout; and
              ...
              {trainingStep === 3 && (
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-[#344767] mb-4">
                      Review your training data and start the AI learning
                      process.
                    </p>
                  </div>

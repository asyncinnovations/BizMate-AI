                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              <DropdownMenu
                                ...
                                items={[
                                  ...
                                  ...(q.status === "accepted" ? [{ label: "Convert to Invoice", onClick: () => setConvertTarget(q), icon: <RefreshCw className="w-4 h-4" />, description: "Create invoice", variant: "default" as const }] : []),
